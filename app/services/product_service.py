...
class ProductService:
    ...
    def create_product(self, name: str, description: Optional[str], 
    ...
    def update_product(self, product_id: int, name: str, description: Optional[str],
                      price: float, stock_quantity: int, version: int) -> Optional[Product]:
        """Update a product."""
        if price < 0:
            raise ValueError("Price cannot be negative")
        if stock_quantity < 0:
